...
| GitHub Repo      | LangChain DeepAgents(Multi-Agents)    | [`langchain_deepagents/deep_research`](./langchain_deepagents/deep_research/README.md)                 | -                                                           | LangChain [Examples](https://github.com/langchain-ai/deepagents) DeepResearch Agent of Tavily and Gemini model                        |
| GitHub Repo      | LangChain DeepAgents(Agents + Skills) | [`langchain_deepagents/content-builder-agent`](./langchain_deepagents/content-builder-agent/README.md) | https://langchain-ai.aiagenta2z.com/content-builder-agent/chat                                                      | LangChain [Examples](https://github.com/langchain-ai/deepagents)  AI Content Builder + Image Generation Agent with Skills + Subagents |
